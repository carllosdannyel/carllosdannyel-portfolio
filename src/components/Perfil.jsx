const Perfil = () => {
  return (
    <div className="bg-gray-100 p-8 shadow rounded-xl md:flex md:p-0 overflow-hidden">
      <img className="w-32 h-32 rounded-full mx-auto md:rounded-none md:w-48 md:h-auto" src="/carlos-daniel.png" alt="" />
      <div className="pt-6 text-center space-y-4 md:text-left md:p-8">
        <div className="text-lg font-semibold">
          ...
          conhecimentos adiquiridos na @betrybe e fora dela.
        </div>
